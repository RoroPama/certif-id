...
export default function BrandingSection() {
  return (
    <div className="lg:w-1/2 relative z-10 flex flex-col justify-between p-10 lg:p-20 lg:border-r border-slate-200/60 bg-white/40 backdrop-blur-sm lg:bg-transparent">
      <div className="space-y-8">
        <div className="inline-flex items-center gap-4 border-b border-slate-200 pb-6 pr-12">
          <div className="w-14 h-14 bg-blue-950 text-white flex items-center justify-center rounded-lg shadow-lg ring-4 ring-white">
            <School className="w-8 h-8" />
          </div>
          <div>
            <h1 className="text-2xl font-serif font-bold tracking-tight text-blue-950 leading-none">
              CERTIF-ID
            </h1>
            <div className="h-0.5 w-12 bg-amber-500 my-1"></div>
        ...
        <div className="space-y-6 max-w-lg">
          <h2 className="text-4xl lg:text-5xl font-serif font-medium text-slate-900 leading-tight">
            ...
            <span className="italic text-blue-900 font-semibold relative inline-block">
              Certification
              <svg
                className="absolute w-full h-2 bottom-0 left-0 text-amber-500/30"
                viewBox="0 0 100 10"
          ...
          <p className="text-slate-600 text-lg font-light leading-relaxed border-l-2 border-amber-500/50 pl-6">
