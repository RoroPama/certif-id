    ...
    <div className="lg:w-1/2 relative z-10 flex flex-col justify-center items-center p-6 bg-slate-50/50">
      <div className="w-full max-w-md relative">
        <div className="absolute -top-20 -right-20 opacity-[0.03] pointer-events-none">
          <FileBadge className="w-64 h-64 text-primary-dark" />
        </div>

        <div className="bg-white rounded-t-xl shadow-large border border-slate-200/60 relative overflow-hidden">
          <div className="h-1.5 w-full bg-gradient-primary"></div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-block bg-white/80 backdrop-blur-glass border border-slate-200 rounded-full px-4 py-2 shadow-soft">
            <p className="text-xs text-slate-500 flex items-center gap-2">
              <span className="font-bold text-primary-dark">OTP DÉMO:</span>
